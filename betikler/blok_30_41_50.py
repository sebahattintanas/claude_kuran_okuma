# -*- coding: utf-8 -*-
"""blok_30_41_50.py — sûre 30 beşinci blok — karada ve denizde bozulma, rüzgârlar ve yağmurun mekanizması.
...
DIK = json.load(open('blok_dikey_30_41_50.json', encoding='utf-8'))
