# -*- coding: utf-8 -*-
"""blok_28_71_80.py — sûre 28 sekizinci blok — sermed nakaratı, gece/gündüz çıpası ve Kārûn'un girişi.
...
DIK = json.load(open('blok_dikey_28_71_80.json', encoding='utf-8'))
