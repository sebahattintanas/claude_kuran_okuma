# -*- coding: utf-8 -*-
"""blok_31_21_30.py — sûre 31 üçüncü blok — atalar, sağlam kulp ve Allah'ın kelimelerinin tükenmezliği.
...
DIK = json.load(open('blok_dikey_31_21_30.json', encoding='utf-8'))
