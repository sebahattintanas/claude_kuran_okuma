# -*- coding: utf-8 -*-
"""blok_30_51_60.py — sûre 30 altıncı ve SON blok — sararan ekin, sağırlık, ömür döngüsü ve sûre kapanışı.
...
DIK = json.load(open('blok_dikey_30_51_60.json', encoding='utf-8'))
