# -*- coding: utf-8 -*-
"""blok_30_21_30.py — sûre 30 üçüncü blok — âyetler dizisinin gövdesi: eşler, çeşitlilik, uyku, şimşek, fıtrat.
...
DIK = json.load(open('blok_dikey_30_21_30.json', encoding='utf-8'))
