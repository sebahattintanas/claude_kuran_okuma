# -*- coding: utf-8 -*-
"""17_cipa_tarama2.py — P0 #6, taramanın morfolojiye bağlanması.
...
json.dump([{'ayet': '%d:%d' % k, 'kokler': ort, 'isaretler': im, 'cipa': k in set(CIPA)}
          ...
          open('cipa_tarama2_adaylari.json', 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
print('\ncipa_tarama2_adaylari.json yazıldı (%d kayıt)' % len(aday))
