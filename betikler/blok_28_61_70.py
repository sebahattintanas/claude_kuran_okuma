# -*- coding: utf-8 -*-
"""blok_28_61_70.py — sûre 28 yedinci blok — vaat karşılaştırması, ortakların sorgusu ve tevhid kapanışı.
...
DIK = json.load(open('blok_dikey_28_61_70.json', encoding='utf-8'))
