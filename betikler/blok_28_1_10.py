# -*- coding: utf-8 -*-
"""blok_28_1_10.py — sûre 28 (Kasas) birinci blok — mukattaa, açılış formülü ve Mûsâ'nın doğum anlatısı.
...
DIK = json.load(open('blok_dikey_28_1_10.json', encoding='utf-8'))
