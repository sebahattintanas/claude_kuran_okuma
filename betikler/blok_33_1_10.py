# -*- coding: utf-8 -*-
"""blok_33_1_10.py — sûre 33 (Ahzâb) birinci blok — üç yeniden-etiketleme reddi, peygamberlerden ahit, kuşatmanın başlangıcı.

uret_blok_33.py tarafından ÜRETİLDİ — elle düzenleme. Ölçüm (›) defterden (olcum_bicim),
...
from ahzab_metin_1 import MEAL, M
from ahzab_kayit import CIPA, ARIZA
