# -*- coding: utf-8 -*-
"""blok_29_61_69.py — sûre 29 yedinci ve SON blok — yaratılış soruları, gemi sahnesi ve sûre kapanışı.
...
DIK = json.load(open('blok_dikey_29_61_69.json', encoding='utf-8'))
