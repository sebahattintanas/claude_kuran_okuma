# -*- coding: utf-8 -*-
"""blok_28_11_20.py — sûre 28 ikinci blok — kız kardeş, anneye dönüş, şehirdeki vuruş ve kaçış kararı.
...
DIK = json.load(open('blok_dikey_28_11_20.json', encoding='utf-8'))
