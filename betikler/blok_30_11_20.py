# -*- coding: utf-8 -*-
"""blok_30_11_20.py — sûre 30 ikinci blok — yaratma döngüsü, vakitler ve 'âyetlerinden biri de' dizisinin açılışı.
...
DIK = json.load(open('blok_dikey_30_11_20.json', encoding='utf-8'))
