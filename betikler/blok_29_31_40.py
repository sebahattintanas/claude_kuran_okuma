# -*- coding: utf-8 -*-
"""blok_29_31_40.py — sûre 29 dördüncü blok — elçilerin gelişi, Şuayb ve helâk türlerinin sınıflanması.
...
DIK = json.load(open('blok_dikey_29_31_40.json', encoding='utf-8'))
